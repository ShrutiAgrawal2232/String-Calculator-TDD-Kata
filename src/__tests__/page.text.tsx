...
import stringCalculator from "@/app/services";
...
describe("StringCalculator", () => {
  ...
  test("Test Negative Number", () => {
    ...
    expect(() => stringCalculator.add("1,-2,3,-5")).toThrow(
      "Negatives not allowed: -2,-5"
    );
  });

  test("Test Over Thousand", () => {
    expect(stringCalculator.add("1000,10")).toBe(10); // Numbers greater than 1000 should be ignored
  });
